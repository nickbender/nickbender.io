...
const IndexPage = () => (
  <Layout>
    ...
    <p>
      Lately, I've been building APIs and web products for <a href='https://my.life'>MyLife</a>,
      but I've also worked on cloud infrastructure at <a href='https://ibm.com'>IBM</a>,
      customer dashboards at <a href='https://a10networks.com'>A10 Networks</a>, and cloud wifi
      managment at Uceem.</p>
    <p>
      <a href='https://www.ruby-lang.org/en/'>Ruby</a> and <a href='https://developer.mozilla.org/en-US/docs/Web/javascript'>js</a> are where I spend the majority of my time. I am also comfortable in a growing number of other languages be they OO or functional, strong or duck-typed.
    </p>
    <p>
    ...
    <p><span role='img' aria-label='robot'>⌨</span></p>
  </Layout>
)
